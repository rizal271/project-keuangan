<div class="page-header" style="background-color: transparent;">
    <h2><i class="fa fa-user" style="height: 50px; width: 50px; border: 1px solid black; padding: 7px; padding-left: 13px; border-radius: 50px"></i> <label>LAPORAN <small>SERTIFIKAT</small></label></h2>
    <div class="page-title" style="background-color: transparent;">
        <ol class="breadcrumb" style="background-color: transparent;">
            <li><a href="#">Dashboard</a></li>
            <li>Laporan</li>
            <li class="active">Laporan Sertifikat</li>
                ...
                <div class="col-lg-12">  
                  <div class="card">
                      <div class="card-header">
                        <strong>Laporan</strong> Sertifikat
                      </div>
                      <div class="card-body card-block">
                        <form action="file_data/lapsertifikat/views/cetak_html.php" method="GET"  class="form-horizontal" target="_blank">
