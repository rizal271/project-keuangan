...
$query = $db->query("SELECT * FROM kelas WHERE id_kelas ='".$_GET['id']."'");
  ...
  <div class="content mt-3" style="margin-left: -5px; width: 102%">
    <div class="card">
      <div class="card-header">
        <strong>Form</strong> Edit Data Kelas
      </div>
      <div class="card-body card-block">
        <form action="?target=kelas&action=update" method="post" enctype="multipart/form-data" class="form-horizontal">
          <input type="hidden" name="id_kelas" value="<?php echo $id_kelas; ?>">
          <div class="row form-group">
            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Nama Kelas</label></div>
            <div class="col-9 col-md-6"><input type="text" name="kelas" placeholder="kelas" class="form-control" value="<?php echo $kelas; ?>"></div>
          </div>        
