...
$query = $db->query("SELECT * FROM master_anggaran WHERE id_master_anggaran ='".$_GET['id']."'");
...
$jenis_anggaran      = $rows->jenis_anggaran;
?>                
  ...
  <div class="content mt-3" style="margin-left: -5px; width: 102%">
    <div class="card">
      ...
      <div class="card-body card-block">
        <form action="?target=master_anggaran&action=update" method="post" enctype="multipart/form-data" class="form-horizontal">
          <input type="hidden" name="id_master_anggaran" value="<?php echo $id_master_anggaran; ?>">
          <div class="row form-group">
            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Jenis Anggaran</label></div>
            <div class="col-9 col-md-6"><input type="text" name="jenis_anggaran" placeholder="jenis_anggaran" class="form-control" value="<?php echo $jenis_anggaran; ?>"></div>
          </div> 
