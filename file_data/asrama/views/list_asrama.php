...
<div class="breadcrumbs" >
  <div class="content mt-3" style="margin-left: -5px; width: 102%">
    <a class="btn btn-success" href="?target=asrama&action=form" style="border-radius: 5px; margin-bottom: 20px; margin-left: 10px" title="Tambah Data"> <i class="fa fa-plus-square"></i></a>
      ...
      ?>
        <tr>
          ...
          <td style="text-align: center;">
            <a class="btn btn-primary" href="admin.php?target=asrama&action=edit&id=<?php echo $id_asrama; ?>" style="border-radius: 5px" title="Edit Data"><i class='fa fa-edit'></i></a>
          
            <a class="btn btn-danger" href="admin.php?target=asrama&action=delete&id=<?php echo $id_asrama; ?>" style="border-radius: 5px" title="Hapus Data"><i class='fa fa-trash'></i> </a>
