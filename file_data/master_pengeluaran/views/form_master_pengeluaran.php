  ...
  <div class="content mt-3" style="margin-left: -5px; width: 102%">
    <div class="card">
      ...
      <div class="card-body card-block">
        <form action="?target=master_pengeluaran&action=input" method="post" enctype="multipart/form-data" class="form-horizontal">
          <input type="hidden" name="id_master_pengeluaran">
          <div class="row form-group">
            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Jenis Pengeluaran</label></div>
            <div class="col-9 col-md-6"><input type="text" name="jenis_pengeluaran" placeholder="jenis_pengeluaran" class="form-control"></div>
          </div> 
