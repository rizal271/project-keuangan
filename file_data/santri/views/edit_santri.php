...
$query = $db->query("SELECT * FROM santri WHERE id_santri ='".$_GET['id']."'");
  ...
  <div class="content mt-3" style="margin-left: -5px; width: 102%">
    <div class="card">
      <div class="card-header">
        <strong>Form</strong> Edit Data Santri
      </div>
      <div class="card-body card-block">
        <form action="?target=santri&action=update" method="post" enctype="multipart/form-data" class="form-horizontal">
          ...
          <div class="row form-group">
            ...
            <div class="col-9 col-md-6"><input type="text" name="nm_santri" placeholder="nm_santri" class="form-control" value="<?php echo $nm_santri; ?>"></div>
          </div>
           ...
           <div class="row form-group">
            ...
            <div class="col-9 col-md-6">
              <select name="id_kamar" id="select" class="form-control">
                <?php  
                $qq = $db->query("SELECT * from kamar where id_kamar = '$id_kamar'");
                $rr = $qq->fetch_array();
                ?>
                <option value="<?php echo $rr['id_kamar'];?>">
                  <?php echo $rr['kamar'];?>
                </option>
                <?php
                include "conf/connection.php";
